...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--kdbwhk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--kdbwhk.containers.anotherwebservice.com/
...
```
git clone git@github.com:jiahao19971/container--kdbwhk.git
cd container--kdbwhk
```
...
```
docker attach container--kdbwhk
```
